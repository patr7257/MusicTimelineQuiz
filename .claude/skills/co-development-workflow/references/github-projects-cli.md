...
- Repo (issues live here): `patr7257/hitster`
...
- Board owner: `patr7257` (personal USER project; use `--owner patr7257` for all
  `gh project` commands)
- Project number: `3` (https://github.com/users/patr7257/projects/3)
- Project node ID: `PVT_kwHOCbc9N84BdhEp`
- Status field ID: `PVTSSF_lAHOCbc9N84BdhEpzhYCEKs` (the BUILT-IN Status field carries the five columns on
  this board; there is no custom Stage field)
- Status option IDs: Backlog `666aa8aa`, Ready `7ee0665c`, In progress `34e24c66`,
  In review `9f9df55c`, Done `04764537`
